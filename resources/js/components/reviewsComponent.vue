        ...
        <div class="col-md-8 reviews-container__content">
            <div class="card reviews-container__content__review-card">
                ...
                <div class="card-body reviews-card__body">
                    <div class="card reviews-card__single-review__wrapper" v-for="review in reviewsTest" v-bind:key="review.id" v-show="review.reviews">
                        <div class="card-body reviews-card__single-review">
                                {{ review.reviews }}
                                <a  class="review-card__single-review_add-comment" style="float:right;  color:blue;  margin-left:10px;" href="/comments">🗨</a>
