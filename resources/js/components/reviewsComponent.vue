    ...
    <div class="row justify-content-center reviews-container">
        <div class="col-md-8 reviews-container__content">
            <div class="card reviews-container__content__review-card">
                ...
                <div class="card-body reviews-card__body" v-for="(review, i) in reviewsTest" :key="i" v-show="review.reviews" >
                    ...
                    {{review.id}}
                     <Comments :comments="comments" :review-id="review.id" v-model="checked"/>
...
export default ({
    ...
    methods: {
        ...
        checkedIds(){
           return EventBus.$on('loaded', (checked)=> checked);
        }
    },
    components:{
        Comments
